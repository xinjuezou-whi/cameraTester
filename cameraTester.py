...
def parse_args():
    ...
    parser.add_argument('--raspi', dest='is_jetson',
                        help='specify as Raspberry Pi board',
                        action='store_false')
    parser.add_argument('--jetson', dest='is_jetson',
...
def main():
    ...
    if args.use_rtsp:
        cap = open_cam_rtsp(args.is_jetson,
                            args.rtsp_uri,
                            args.image_width,
                            args.image_height,
                            args.rtsp_latency)
    elif args.use_usb:
        cap = open_cam_usb(args.is_jetson,
                            args.video_dev,
                            args.image_width,
                            args.image_height)
    else: # by default, use the Jetson onboard camera
        cap = open_cam_onboard(args.is_jetson,
                                args.image_width,
                                args.image_height)
